...
var _reactIs = __webpack_require__(13);
  ...
  return chunks.reduce(function (ruleSet, chunk) {
    ...
    if (typeof chunk === 'function') {
      if (executionContext) {
        ...
        if (_react2.default.isValidElement(nextChunk)) {
...
var StyledRadioLabel = _styledComponents2.default.label(_templateObject2);

var THEMES = _cssThemes2.default.themes.reduce(function (output, theme) {
  return Object.assign({}, output, _defineProperty({}, theme.name, theme));
}, {});
...
registerBlockType('colbycomms/divider', {
  ...
  edit: function edit(_ref) {
    ...
    color = color || THEMES[_cssThemes2.default.defaultTheme]['background-color'];
    height = height || 32;
    ...
    var controls = isSelected && _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _cssThemes2.default.themes.map(function (theme) {
          return theme['background-color'] ? _react2.default.createElement(
            StyledRadioLabel,
            { key: theme.name },
    ...
    return [controls, _react2.default.createElement('hr', {
      className: 'divider',
...
registerBlockType('colbycomms/themed-block', {
  ...
  edit: function edit(_ref) {
    var attributes = _ref.attributes,
        setAttributes = _ref.setAttributes,
        isSelected = _ref.isSelected;
    var themeName = attributes.themeName,
        width = attributes.width;

    themeName = themeName || THEMES[_cssThemes2.default.defaultTheme].name;
    width = width || '';
    ...
    var controls = isSelected && _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          StyledRadioLabel,
          { key: 'fluid' },
          _react2.default.createElement('input', { type: 'radio', value: 'fluid', checked: width === 'fluid' }),
          'Full (will fill its container element)'
        ),
        _react2.default.createElement(
          StyledRadioLabel,
          { key: 'xl' },
          _react2.default.createElement('input', { type: 'radio', value: 'xl', checked: width === 'xl' }),
          'Extra large (1200px)'
        ),
        _react2.default.createElement(
          StyledRadioLabel,
          { key: '' },
          _react2.default.createElement('input', { type: 'radio', value: '', checked: width === '' }),
          'Large (1140px)'
        ),
        _react2.default.createElement(
          StyledRadioLabel,
          { key: 'lg' },
          _react2.default.createElement('input', { type: 'radio', value: 'lg', checked: width === 'lg' }),
          'Medium (900px)'
        ),
        _react2.default.createElement(
          StyledRadioLabel,
          { key: 'md' },
          _react2.default.createElement('input', { type: 'radio', value: 'md', checked: width === 'md' }),
          'Small (768px)'
        ),
        _react2.default.createElement(
          StyledRadioLabel,
          { key: 'sm' },
          _react2.default.createElement('input', { type: 'radio', value: 'sm', checked: width === 'sm' }),
          'Extra small (568px)'
        )
      )
    );
    ...
    return [controls, _react2.default.createElement(
      'div',
      {
        className: 'themed-block ' + themeName + ' container' + (width ? '-' + width : '')
      },
      _react2.default.createElement(InnerBlocks, { layouts: { 'inner-block': {} } })
    )];
  },
  save: function save(_ref2) {
    var attributes = _ref2.attributes;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(InnerBlocks.Content, null)
    );
  }
});
